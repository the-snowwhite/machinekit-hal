...
_CONNECTOR = _descriptor.Descriptor(
  ...
  serialized_options=_b('\222?\003H\374\002'),
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_FIRMWARE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\222?\002\010\036'), file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\222?\002\010P'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
  ...
  serialized_options=_b('\222?\003H\201\003'),
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_FIRMWARE.fields_by_name['build_sha']._options = None
_FIRMWARE.fields_by_name['fpga_part_number']._options = None
_FIRMWARE.fields_by_name['connector']._options = None
_FIRMWARE.fields_by_name['board_name']._options = None
_FIRMWARE.fields_by_name['comment']._options = None
_FIRMWARE._options = None
