...
_RTAPI_MESSAGE = _descriptor.Descriptor(
  ...
  serialized_options=_b('\222?\003H\350\007'),
  is_extendable=False,
  syntax='proto2',
  extension_ranges=[],
  oneofs=[
...
_RTAPI_MESSAGE.fields_by_name['format']._options = None
_RTAPI_MESSAGE.fields_by_name['arg']._options = None
_RTAPI_MESSAGE._options = None
